...
export interface UsdcTokenContractInterface {
    events: {
        "Approval(address indexed owner, address indexed spender, uint256 value)": EventFragment
        "Burn(address indexed burner, uint256 value)": EventFragment
    ...
    functions: {
        ...
        "INITIAL_SUPPLY() view returns (uint256)": FunctionFragment
        "allowance(address _owner, address _spender) view returns (uint256)": FunctionFragment
        "approve(address _spender, uint256 _value) returns (bool)": FunctionFragment,
        "balanceOf(address _owner) view returns (uint256 balance)": FunctionFragment
        "burn(uint256 _value)": FunctionFragment
        "close()": FunctionFragment
        "decimalFactor() view returns (uint256)": FunctionFragment
        "decimals() view returns (uint8)": FunctionFragment
        "decreaseApproval(address _spender, uint256 _subtractedValue) returns (bool)": FunctionFragment
        "increaseApproval(address _spender, uint256 _addedValue) returns (bool)": FunctionFragment
        "mint(address to, uint256 value) returns (bool)": FunctionFragment
        "name() view returns (string)": FunctionFragment
        "owner() view returns (address)": FunctionFragment
        "start()": FunctionFragment
        "stop()": FunctionFragment
        "stopped() view returns (bool)": FunctionFragment
        "symbol() view returns (string)": FunctionFragment
        "totalSupply() view returns (uint256)": FunctionFragment
        "transfer(address _to, uint256 _value) returns (bool)": FunctionFragment
        "transferFrom(address _from, address _to, uint256 _value) returns (bool)": FunctionFragment
